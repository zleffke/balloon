...
if __name__ == '__main__':
    ...
    parser.add_option("--gb", dest = "gps_baud" , action = "store", type = "int"   , default="9600"        , help = gb_help)
    ...
    parser.add_option("--tb", dest = "tnc_baud" , action = "store", type = "int"   , default="9600"        , help = tb_help)
    parser.add_option("--tf", dest = "tnc_log"  , action = "store", type = "string", default=None          , help = tf_help)
    parser.add_option("--cs", dest = "callsign" , action = "store", type = "string", default="KJ4OAP-11"   , help = cs_help)
