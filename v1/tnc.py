...
class TNC_Thread(threading.Thread):
    ...
    def run(self):
        while (not self._stop.isSet()):
            ...
            #data = "KJ4OAP-11>APLIGA,WIDE1-1,WIDE2-1,qAO,KJ4OAP-10:/205003h3712.41N/08025.14WO000/000/A=002082 003TxC  24.10C  940.62hPa  5.07V 05S HAB@VT Go Hokies! kevintyler at vt.edu"
            if self.log_flag != None:
                self.log_file = open(self.log_flag,'a')
